...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Greek Life Events.</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <button type="button"><a href="newEventPage.php">Create A New Event</a></button>
  </div>
  ...
  <?php
    ...
    $sql = "SELECT chapter_id, org_benefitted, event_date, event_name FROM Socials";
...
<table style="background-color: #FAA77E ;">
            <tr>
                ...
                <td>Event Name</td>
                <td>Date</td>
                <td>Organization Benefitted</td>
            </tr>

            <?php while ($row1 = mysqli_fetch_array($testResult)):;?>
            <?php
            $chaptersql = "SELECT chapter_name FROM Chapter WHERE chapter_id = $row1[0]";
