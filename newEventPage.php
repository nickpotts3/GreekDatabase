...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>New Event</b></h1>
...
<div class="w3-container" id="contact" style="margin-top:75px">
    <form action="newEventCreatedPage.php" target="_blank" method="post">
      ...
      <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="text" name="chapter_id" required>
      </div>
      <div class="w3-section">
        <label>Event Date</label>
        <input class="w3-input w3-border" type="date" name="event_date" required>
      </div>
      <div class="w3-section">
        <label>Event ID</label>
        <input class="w3-input w3-border" type="text" name="event_id" required>
      </div>
      <div class="w3-section">
        <label>Organization Benefitted</label>
        <input class="w3-input w3-border" type="text" name="org_benefitted" required>
      </div>
      <button type="submit" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom">Create Event</button>
    </form>  
  </div>
